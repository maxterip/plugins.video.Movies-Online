...
def run():
    ...
    plugintools.log("---> Movies-Online.run <---")
...
def main_list(params):
    plugintools.log("[Movies-Online-0.3.0].main_list "+repr(params))
   
    # Control del skin de Movies-Online
    mastermenu = xml_skin()
    plugintools.log("XML menu: "+mastermenu)
    try:
        data = plugintools.read(mastermenu)
    except:
        mastermenu = 'http://pastebin.com/raw.php?i=utgpjjVM'
        data = plugintools.read(mastermenu)
        xbmc.executebuiltin("Notification(%s,%s,%i,%s)" % ('Movies-Online', "XML no reconocido...", 3 , art+'icon.png'))    
...
def play(params):
    plugintools.log("[Movies-Online-0.3.0].play "+repr(params))
    # plugintools.direct_play(params.get("url"))
    # xbmc.Player(xbmc.PLAYER_CORE_AUTO).play(params.get("url"))
    plugintools.log("[Movies-Online 0.2.85]: Playing file...")
    url = params.get("url")
...
def live_items_withlink(params):
    plugintools.log("[Movies-Online-0.3.0].live_items_withlink "+repr(params))
...
def xml_lists(params):
    plugintools.log("[Movies-Online-0.3.0].xml_lists "+repr(params))
    data = plugintools.read( params.get("url") )
...
def getstreams_now(params):
    plugintools.log("[Movies-Online-0.3.0].getstreams_now "+repr(params))
...
def livestreams_channels(params):
    plugintools.log("[Movies-Online-0.3.0].livestreams_channels "+repr(params))
    data = plugintools.read( params.get("url") )
...
def livestreams_subchannels(params):
    plugintools.log("[Movies-Online-0.3.0].livestreams_subchannels "+repr(params))
...
def livestreams_subitems(params):
    plugintools.log("[Movies-Online-0.3.0].livestreams_subitems "+repr(params))
...
def livestreams_items(params):
    plugintools.log("[Movies-Online-0.3.0].livestreams_items "+repr(params))
...
def xml_items(params):
    plugintools.log("[Movies-Online-0.3.0].xml_items "+repr(params))
    data = plugintools.read( params.get("url") )
    thumbnail = params.get("thumbnail")
...
def simpletv_items(params):
    plugintools.log("[Movies-Online-0.3.0].simpletv_items "+repr(params))
    ...
    if title == 'search.txt':
        ...
        data = file.readline()
        if data == "":
            ok = plugintools.message("Movies-Online", "Sin resultados")
            return ok
    else:
        title = params.get("title")
...
def myplaylists_m3u(params):  # Mis listas M3U
    plugintools.log("[Movies-Online-0.3.0].myplaylists_m3u "+repr(params))
    thumbnail = params.get("thumbnail")
...
def playlists_m3u(params):  # Biblioteca online
    plugintools.log("[Movies-Online-0.3.0].playlists_m3u "+repr(params))
    data = plugintools.read( params.get("url") )
    ...
    params["ext"] = 'm3u'
    plugintools.add_item( action="" , title='[B][COLOR yellow]'+name_channel+'[/B][/COLOR] - [B][I][COLOR lightyellow]Movies-Online [/COLOR][/B][/I]' , thumbnail= art + 'icon.png' , folder = False , isPlayable = False )    
...
def getfile_http(params):  # Descarga de lista M3U + llamada a simpletv_items para que liste los items
    plugintools.log("[Movies-Online-0.3.0].getfile_http "+repr(params))
    url = params.get("url")
    params["ext"] = "m3u"
    getfile_url(params)
...
def getfile_url(params):
    plugintools.log("[Movies-Online-0.3.0].getfile_url " +repr(params))
    ext = params.get("ext")
    title = params.get("title")
...
def header_xml(params):
    plugintools.log("[Movies-Online-0.3.0].header_xml "+repr(params))
...
def search_channel(params):
    plugintools.log("[Movies-Online-0.3.0].search " + repr(params))
    ...
    if buscar == "":
        ...
        cat = ""
        if texto == "":
            errormsg = plugintools.message("Movies-Online","Por favor, introduzca el canal a buscar")
            return errormsg
...
def agendatv(params):
    plugintools.log("[Movies-Online-0.3.0].agendatv "+repr(params))
...
def plx_items(params):
    plugintools.log("[Movies-Online-0.3.0].plx_items" +repr(params))
...
def futbolenlatv(params):
    plugintools.log("[Movies-Online-0.3.0].futbolenlaTV "+repr(params))
...
def encode_string(txt):
    plugintools.log("[Movies-Online-0.3.0].encode_string: "+txt)
...
def splive_items(params):
    plugintools.log("[Movies-Online-0.3.0].SPlive_items "+repr(params))
    data = plugintools.read( params.get("url") )
...
def p2p_items(params):
    plugintools.log("[Movies-Online-0.3.0].p2p_items" +repr(params))
    ...
    # Controlamos el caso en que no haya thumbnail en el menú de Movies-Online
    if thumbnail == "":
...
def contextMenu(params):
    plugintools.log("[Movies-Online-0.3.0].contextMenu " +repr(params))
    ...
    if len_canales == 1:        
        ...
        if len_canales == 2:
            ...
            selector = dialog.select('Movies-Online', [tv_a, tv_b])
            ...
            selector = dialog.select('Movies-Online', [tv_a, tv_b, tv_c])
            ...
            selector = dialog.select('Movies-Online', [tv_a, tv_b, tv_c, tv_d])
            ...
            selector = dialog.select('Movies-Online', [tv_a, tv_b, tv_c, tv_d, tv_e])
            ...
            selector = dialog.select('Movies-Online', [tv_a , tv_b, tv_c, tv_d, tv_e, tv_f])
            ...
            selector = dialog.select('Movies-Online', [tv_a , tv_b, tv_c, tv_d, tv_e, tv_f, tv_g])
...
def magnet_items(params):
    plugintools.log("[Movies-Online-0.3.0].magnet_items" +repr(params))
...
def parser_title(title):
    plugintools.log("[Movies-Online-0.3.0].parser_title " + title)
...
def json_items(params):
    plugintools.log("[Movies-Online-0.3.0].json_items "+repr(params))
    data = plugintools.read(params.get("url"))
...
def youtube_playlists(params):
    plugintools.log("[Movies-Online-0.3.0].youtube_playlists "+repr(params))
...
def youtube_videos(params):
    plugintools.log("[Movies-Online-0.3.0].youtube_videos "+repr(params))
...
def server_rtmp(params):
    plugintools.log("[Movies-Online-0.3.0].server_rtmp " + repr(params))
...
def launch_rtmp(params):
    plugintools.log("[Movies-Online-0.3.0].launch_rtmp " + repr(params))
...
def peliseries(params):
    plugintools.log("[Movies-Online-0.3.0].peliseries " +repr(params))
...
def tinyurl(params):
    plugintools.log("[Movies-Online-0.3.0].tinyurl "+repr(params))
    ...
    xbmc.executebuiltin("Notification(%s,%s,%i,%s)" % ('Movies-Online', "Redireccionando enlace...", 3 , art+'icon.png'))
...
def longurl(params):
    plugintools.log("[Movies-Online-0.3.0].longURL "+repr(params))
...
def arenavision_parser(params):
    plugintools.log("[Movies-Online-0.3.0].arenavision_parser "+repr(params))
...
def parse_av_channel(title, url, params):
    plugintools.log("[Movies-Online-0.3.0].parse_av_channel "+repr(params))
...
def seriecatcher(params):
    plugintools.log("[Movies-Online-0.3.0].seriecatcher "+repr(params))
...
def GetSerieChapters(params):
    plugintools.log("[Movies-Online-0.3.0].GetSerieChapters "+repr(params))
...
def GetSerieLinks(fanart , url_cap_fixed, i, title_fixed):
    plugintools.log("[Movies-Online-0.3.0].GetSerieLinks")
...
def SelectTemp(params, temp):
    plugintools.log("[Movies-Online-0.3.0].SelectTemp "+repr(params))
    ...
    if seasons == 1:
        selector = dialog.select('Movies-Online', [temp[0]])
                                             
    if seasons == 2:
        selector = dialog.select('Movies-Online', [temp[0], temp[1]])
                                             
    if seasons == 3:
        selector = dialog.select('Movies-Online', [temp[0],temp[1], temp[2]])
                                             
    if seasons == 4:
        selector = dialog.select('Movies-Online', [temp[0], temp[1],temp[2], temp[3]])
                                             
    if seasons == 5:
        selector = dialog.select('Movies-Online', [temp[0], temp[1],temp[2], temp[3], temp[4]])
        
    if seasons == 6:
        selector = dialog.select('Movies-Online', [temp[0], temp[1],temp[2], temp[3], temp[4], temp[5]])
        
    if seasons == 7:
        selector = dialog.select('Movies-Online', [temp[0], temp[1],temp[2], temp[3], temp[4], temp[5], temp[6]])
        
    if seasons == 8:
        selector = dialog.select('Movies-Online', [temp[0], temp[1],temp[2], temp[3], temp[4], temp[5], temp[6], temp[7]])
        
    if seasons == 9:
        selector = dialog.select('Movies-Online', [temp[0], temp[1],temp[2], temp[3], temp[4], temp[5], temp[6], temp[7], temp[8]])
        
    if seasons == 10:
        selector = dialog.select('Movies-Online', [temp[0], temp[1],temp[2], temp[3], temp[4], temp[5], temp[6], temp[7], temp[8], temp[9]])                               
...
def m3u_items(title):
    plugintools.log("[Movies-Online-0.3.0].m3u_items= "+title)
...
def xml_skin():
    plugintools.log("[Movies-Online-0.3.0].xml_skin")
    ...
    if xmlmaster == 'true':
        if SelectXMLmenu == '0':
            ...
            plugintools.log("[Movies-Online.xml_skin: "+SelectXMLmenu)
            # Control para ver la intro de Movies-Online
            ...
            if id_pastebin == "":
                plugintools.log("[Movies-Online.xml_skin: No definido")                
                mastermenu = 'http://pastebin.com/raw.php?i=bjCUnJjG'
            else:                
                mastermenu = 'http://pastebin.com/raw.php?i=' +id_pastebin
                plugintools.log("[Movies-Online.xml_skin: "+mastermenu)
