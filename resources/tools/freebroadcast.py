...
def freebroadcast(params):
    plugintools.log("[Movies-Online 0.0.1].freebroadcast "+repr(params))
    url_user = {}
...
def getparams_freebroadcast(url_user, body):
    plugintools.log("[Movies-Online 0.0.1].getparams_freebroadcast " + repr(url_user) )
...
def getfile_freebroadcast(url_user, decoded, body):
    plugintools.log("tvspot getfile_freebroadcast( "+repr(url_user))
    referer = url_user.get("referer")
...
def get_fileserver(decoded, url_user):
    plugintools.log("tvspot fileserver "+repr(url_user))
