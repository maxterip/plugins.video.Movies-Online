# -*- coding: utf-8 -*-
#------------------------------------------------------------
# Movies-Online Parser de laligatv.es
...
def laligatv(params):
    plugintools.log("[Movies-Online 0.0.1].laligatv.es Playlist Sport Channels( "+repr(params))
...
def adelante_geturl(params):
    plugintools.log("[Movies-Online 0.0.1].LaLigatv.es getURL: "+repr(params))
