# -*- coding: utf-8 -*-
#------------------------------------------------------------
# Movies-Online - XBMC Add-on by 19hdz19
# Version 0.0.1 (17.11.2014)
#------------------------------------------------------------
...
def main_list(params):
    plugintools.log("[Movies-Online-0.0.1].main_list "+repr(params))
...
def play(params):
    plugintools.log("[Movies-Online-0.0.1].play "+repr(params))
...
def live_items_withlink(params):
    plugintools.log("[Movies-Online-0.0.1].live_items_withlink "+repr(params))
...
def xml_lists(params):
    plugintools.log("[Movies-Online-0.0.01].xml_lists "+repr(params))
    data = plugintools.read( params.get("url") )
...
def getstreams_now(params):
    plugintools.log("[Movies-Online-0.0.1].getstreams_now "+repr(params))
...
def livestreams_channels(params):
    plugintools.log("[Movies-Online-0.0.1].livestreams_channels "+repr(params))
    data = plugintools.read( params.get("url") )
...
def livestreams_subchannels(params):
    plugintools.log("[Movies-Online-0.0.1].livestreams_subchannels "+repr(params))
...
def livestreams_subitems(params):
    plugintools.log("[Movies-Online-0.0.1].livestreams_subitems "+repr(params))
...
def livestreams_items(params):
    plugintools.log("[Movies-Online-0.0.1].livestreams_items "+repr(params))
...
def xml_items(params):
    plugintools.log("[Movies-Online-0.0.1].xml_items "+repr(params))
    data = plugintools.read( params.get("url") )
    thumbnail = params.get("thumbnail")
...
def simpletv_items(params):
    plugintools.log("[Movies-Online-0.0.1].simpletv_items "+repr(params))
...
def myplaylists_m3u(params):  # Mis listas M3U
    plugintools.log("[Movies-Online-0.0.1].myplaylists_m3u "+repr(params))
    thumbnail = params.get("thumbnail")
...
def playlists_m3u(params):  # Biblioteca online
    plugintools.log("[Movies-Online-0.0.1].playlists_m3u "+repr(params))
    data = plugintools.read( params.get("url") )
    ...
    params["ext"] = 'm3u'
    plugintools.add_item( action="" , title='[B][COLOR yellow]'+name_channel+'[/B][/COLOR] - [B][I][COLOR lightyellow]19raul7269@gmail.com [/COLOR][/B][/I]' , thumbnail= art + 'icon.png' , folder = False , isPlayable = False )    
...
def getfile_http(params):  # Descarga de lista M3U + llamada a simpletv_items para que liste los items
    plugintools.log("[Movies-Online-0.0.1].getfile_http "+repr(params))
    url = params.get("url")
    params["ext"] = "m3u"
    getfile_url(params)
...
def getfile_url(params):
    plugintools.log("[Movies-Online-0.0.1].getfile_url " +repr(params))
    ext = params.get("ext")
    title = params.get("title")
...
def header_xml(params):
    plugintools.log("[Movies-Online-0.0.1].header_xml "+repr(params))
...
def search_channel(params):
    plugintools.log("[Movies-Online-0.0.1].search " + repr(params))
...
def agendatv(params):
    plugintools.log("[Movies-Online-0.0.1].agendatv "+repr(params))
...
def plx_items(params):
    plugintools.log("[Movies-Online-0.0.1].plx_items" +repr(params))
...
def futbolenlatv(params):
    plugintools.log("[Movies-Online-0.0.1].futbolenlaTV "+repr(params))
...
def encode_string(txt):
    plugintools.log("[Movies-Online-0.0.1].encode_string: "+txt)
...
def splive_items(params):
    plugintools.log("[Movies-Online-0.0.1].SPlive_items "+repr(params))
    data = plugintools.read( params.get("url") )
...
def p2p_items(params):
    plugintools.log("[Movies-Online-0.0.1].p2p_items" +repr(params))
...
def contextMenu(params):
    plugintools.log("[Movies-Online-0.0.1].contextMenu " +repr(params))
...
def magnet_items(params):
    plugintools.log("[Movies-Online-0.0.1].magnet_items" +repr(params))
...
def parser_title(title):
    plugintools.log("[Movies-Online-0.0.1].parser_title " + title)
...
def json_items(params):
    plugintools.log("[Movies-Online-0.0.1].json_items "+repr(params))
    data = plugintools.read(params.get("url"))
...
def youtube_playlists(params):
    plugintools.log("[Movies-Online-0.0.1].youtube_playlists "+repr(params))
...
def youtube_videos(params):
    plugintools.log("[Movies-Online-0.0.1].youtube_videos "+repr(params))
...
def server_rtmp(params):
    plugintools.log("[Movies-Online-0.0.1].server_rtmp " + repr(params))
...
def launch_rtmp(params):
    plugintools.log("[Movies-Online-0.0.1].launch_rtmp " + repr(params))
...
def peliseries(params):
    plugintools.log("[Movies-Online-0.0.1].peliseries " +repr(params))
...
def tinyurl(params):
    plugintools.log("[Movies-Online-0.0.1].tinyurl "+repr(params))
...
def longurl(params):
    plugintools.log("[Movies-Online-0.0.1].longURL "+repr(params))
...
def arenavision_parser(params):
    plugintools.log("[Movies-Online-0.0.1].arenavision_parser "+repr(params))
...
def parse_av_channel(title, url, params):
    plugintools.log("[Movies-Online-0.0.1].parse_av_channel "+repr(params))
...
def seriecatcher(params):
    plugintools.log("[Movies-Online-0.0.1].seriecatcher "+repr(params))
...
def GetSerieChapters(params):
    plugintools.log("[Movies-Online-0.0.1].GetSerieChapters "+repr(params))
...
def GetSerieLinks(fanart , url_cap_fixed, i, title_fixed):
    plugintools.log("[Movies-Online-0.0.1].GetSerieLinks")
...
def SelectTemp(params, temp):
    plugintools.log("[Movies-Online-0.0.1].SelectTemp "+repr(params))
...
def m3u_items(title):
    plugintools.log("[Movies-Online-0.0.1].m3u_items= "+title)
...
def xml_skin():
    plugintools.log("[Movies-Online-0.0.1].xml_skin")
    ...
    if xmlmaster == 'true':
        if SelectXMLmenu == '0':
            ...
            if mastermenu == "":
                plugintools.log("[latiototal.xml_skin: No definido")
                mastermenu = 'http://pastebin.com/raw.php?i=n9BF6Cwe '                
                # Control para ver la intro de PalcoTV
                ver_intro = plugintools.get_setting("ver_intro")
                if ver_intro == "true":
