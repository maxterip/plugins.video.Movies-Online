# -*- coding: utf-8 -*-
#------------------------------------------------------------
# Movies-Online Regex de 9straem
...
def ninestreams(params):
    plugintools.log("[Movies-Online 0.0.1].ninestreams "+repr(params))
    url_user = {}
...
def getparams_ninestream(url_user, body):
    plugintools.log("[Movies-Online 0.0.1].getparams_ninestream " + repr(url_user) )
...
def getfile_ninestream(url_user, decoded, body):
    plugintools.log("tvspot getfile_ninestream( "+repr(url_user))
    referer = url_user.get("referer")
