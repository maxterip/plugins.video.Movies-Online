# -*- coding: utf-8 -*-
#------------------------------------------------------------
# Movies-Online Parser de latuerka (Público TV)
...
def latuerka_menu(params):
    plugintools.log("[Movies-Online] La Tuerka Parser( "+repr(params))
...
def program_capis(params):
    plugintools.log("[Movies-Online 0.0.1].LaTuerka Videos"+repr(params))
...
def tuerka_link(url_programa):
    plugintools.log("[Movies-Online 0.0.1].LaTuerka Link " + url_programa)
