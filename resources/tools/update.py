...
resources = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.tvspot/resources', ''))
...
def bajalib(params, platform, libdir, filename):
    plugintools.log("[tvspot 4.0].bajalib "+platform)
    ...
    xbmc.executebuiltin("Notification(%s,%s,%i,%s)" % ('tvspot', "Librería actualizada!", 3 , art+'icon.png'))
    return 0 #succesful



def get_system_platform(params):
    plugintools.log("[tvspot 4.0].get_system_platform " + repr(params))
