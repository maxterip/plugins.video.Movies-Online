...
def torrentone(params):
    plugintools.log("[tvspot 4.0].Playlist Sport Channels Torrent1( "+repr(params))
...
def gethash_torrentone(params):
    plugintools.log("[tvspot 4.0].gethash_torrentone( "+repr(params))
