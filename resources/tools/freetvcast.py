# -*- coding: utf-8 -*-
#------------------------------------------------------------
# Movies-Online Regex de freetvcast
...
def freetvcast(params):
    plugintools.log("[Movies-Online 0.0.1].resolve_freetvcast " + repr(params) )
...
def play_freetvcast(freetvcast_user):
    plugintools.log("[Movies-Online 0.0.1].freetvcast User= " + repr(freetvcast_user) )
